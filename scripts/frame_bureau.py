...
MODULES = [
    ...
    ('Module 2 · Who holds power', 'Political risk analysis',
     [('masterclass', 'A former finance minister and central bank director on how decisions are really taken inside '
                      'a state.'),
...
<section class="section container" id="the-programme"><div class="section-heading"><div><div class="eyebrow">The programme</div><h2>Five modules</h2></div></div><div class="standards-grid">{modules}</div></section>
<section class="section container" id="the-bench"><div class="section-heading"><div><div class="eyebrow">The bench</div><h2>Taught by the people who do it</h2></div><p>The Bureau teaches from a working consortium rather than a faculty list. People who have sat in the room where the decision was taken, editors who have run the investigation, and the data scientists who built the desks.</p></div><div class="standards-grid">{bench}</div></section>
