...
ITEMS_ES = {
    ...
    'worked-examples.html': ('Ejemplos de trabajo', 'Cinco encargos, descritos por tipo.'),
    ...
    'frame-bureau.html': ('The Frame Bureau', 'Formar a una institución para que lleve su propia mesa.'),
