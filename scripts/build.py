...
from bureau import bureau_page
...
<footer class="site-footer"><div class="container"><div class="footer-top"><div>{brand(prefix)}<p>A clearer view of a complex world.</p><span class="eyebrow">Evidence. Context. Judgment.</span></div><div><h2>Explore</h2><a href="{prefix}capabilities.html">Research capabilities</a><a href="{prefix}government-affairs.html">Government affairs</a><a href="{prefix}distressed-debt.html">Distressed debt</a><a href="{prefix}venezuela.html">Venezuela programme</a><a href="{prefix}research.html">Intelligence library</a><a href="{prefix}coverage.html">Regional coverage</a><a href="{prefix}methodology.html">Our approach</a></div><div><h2>Connect</h2><a href="{prefix}briefing.html?kind=contact">Contact us</a><a href="{prefix}engagement.html">Working with EchoFrame</a><a href="mailto:contact@echoframe.co">contact@echoframe.co</a><a href="https://ie.linkedin.com/company/echoframing" target="_blank" rel="noopener noreferrer">LinkedIn </a></div><div><h2>Company</h2><a href="{prefix}about.html">About EchoFrame</a><a href="{prefix}frame-bureau.html">The Frame Bureau</a><a href="{prefix}trust.html">Trust &amp; privacy</a><a href="{prefix}sample-briefs.html">Sample briefs &amp; templates</a><a href="{prefix}sources.html">Primary-source directory</a><a href="{prefix}editorial-standards.html">Editorial standards</a><a href="{prefix}{'index.html' if lang=='es' else 'es/index.html'}" lang="{'en' if lang=='es' else 'es'}">{'English' if lang=='es' else 'En español'}</a></div></div><div class="footer-bottom"><span>© 2026 {E(SITE['legal_name'])}{' · '+E(SITE['registration_line']) if SITE['registration_line'] else ''}</span><span><a href="{prefix}privacy.html">Privacy</a><span class="meta-dot">/</span>Intelligence with perspective.</span><a href="#main">Back to top </a></div></div></footer></body></html>'''
...
def main():
    ...
    write('frame-bureau.html','The Frame Bureau',bureau_page(),'bureau',description='The Frame Bureau is EchoFrame’s training division, bringing investigative journalism, data science, and political risk analysis into practical learning.')
    ...
    files += ['images/'+r['image'] for r in REGIONS if r['id'] != 'latin-america']
