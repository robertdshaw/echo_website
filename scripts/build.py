...
def methodology():
    ...
    return intro('Our method / Evidence to judgment', 'Political science,<br><em>run as data science</em>', 'Five analytical layers connect reporting to events, actors, incentives, and possible outcomes. The reasoning should be visible enough to challenge, and clear enough to use in a decision.')+analytical_layers()+worked_example("the analytical method")+evidence_flow()+evidence_demo+hard_questions()+cta()
