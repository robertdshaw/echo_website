...
def home_directory():
    return '''<section class="section container site-directory"><div class="section-heading"><div><div class="eyebrow">Inside EchoFrame</div><h2>More to explore.<br>More to work with.</h2></div><p>Go from the overview to the method, the evidence, and the output. Choose the level of detail you need.</p></div><div class="depth-link-grid"><a href="how-it-works.html"><span>01 / THE METHOD</span><h3>How the work is done.</h3><p>The six steps, and how a development is confirmed.</p><b></b></a><a href="sample-briefs.html"><span>02 / THE FINISHED FORMAT</span><h3>Forthcoming research briefs</h3><p>Blank templates and space for real, redacted research material.</p><b></b></a><a href="sources.html"><span>03 / THE SOURCE RECORD</span><h3>Start with primary sources.</h3><p>Official research references, use notes, and the limits to keep in view.</p><b></b></a></div><div class="directory-bottom"><a href="trust.html">Trust, privacy & source handling </a><a href="engagement.html">How a research engagement works </a></div></section>'''
